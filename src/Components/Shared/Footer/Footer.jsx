...
const Footer = () => {
  return (
    <div>
      <footer className="footers card_color xsm:w-[100%] mt-5 lg:mt-[100px]">
        <div className="containers lg:w-[80%]">
          <div className="footer_inner">
            <div className="c-footer">
              <div className="layoutss">
                <div className="layout_item w-50">
                  <div className="newsletter">
                    <h3 className="newsletter_title h3Text">
                      CozyNest, the best place to find your best room.
                    </h3>
                    <form action="" className="formik relative">
                      <input
                        type="text"
                      ...
                      <button className="buttonItem">
                        <svg
                          ...
                          width={24}
                          height={24}
                          className="svgg absolute top-2 right-2"
                        >
                ...
                <div className="layout_item w-25">
                  <nav className="c-nav-tool">
                    ...
                    <ul className="c-nav-tool_list ulItems">
                      <li>
                        <a href="/collections/all" className="c-link aText">
                          Shop All
                        </a>
                      </li>
                      <li>
                        <a href="/pages/about-us" className="c-link aText">
                          About Us
                        </a>
                      </li>
                      <li>
                        <a href="/blogs/community" className="c-link aText">
                          Community
                        </a>
                      </li>
                      <li>
                        <a href="#" className="c-link aText">
                          Vibes
                        </a>
                      </li>
                    </ul>
                    ...
                    <ul className="c-nav-tool_list">
                      <li className="c-nav-tool_item">
                        <a
                          ...
                          className="c-link aText"
                        >
                          Shipping &amp; Returns
                        </a>
                      </li>
                      <li className="c-nav-tool_item">
                        <a href="/pages/help" className="c-link aText">
                          Help &amp; FAQ
                        </a>
                      </li>
                      <li className="c-nav-tool_item">
                      ...
                      <li className="c-nav-tool_item">
                        <a href="/pages/contact" className="c-link aText">
                          Contact
                        </a>
                      </li>
                      <li className="c-nav-tool_item">
                        <Link to="login" className="c-link aText">
                          Login
                        </Link>
                      </li>
                    </ul>
          ...
          <div className="footer_copyright text-center">
            <p>© 2024 The CozyNest All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
